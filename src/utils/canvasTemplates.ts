...
export const THEME_CONFIGS: Record<BoardTheme, ThemeColors> = {
  dark: {
    canvasBg: "#090d13",
    sheetBg: "#121820",
    primaryLine: "rgba(255, 255, 255, 0.08)",
    secondaryLine: "rgba(255, 255, 255, 0.04)",
    majorLine: "rgba(56, 189, 248, 0.22)",
    dots: "rgba(255, 255, 255, 0.16)",
    marginLine: "rgba(251, 113, 133, 0.35)",
    accent: "#38BDF8",
  ...
  light: {
    canvasBg: "#f8fafc",
    sheetBg: "#ffffff",
    primaryLine: "rgba(15, 23, 42, 0.09)",
    secondaryLine: "rgba(15, 23, 42, 0.04)",
    majorLine: "rgba(37, 99, 235, 0.22)",
    dots: "rgba(15, 23, 42, 0.20)",
    marginLine: "rgba(225, 29, 72, 0.40)",
    accent: "#2563EB",
    subtleText: "rgba(15, 23, 42, 0.35)",
  },
  blueprint: {
    canvasBg: "#071b30",
    sheetBg: "#0a2544",
    primaryLine: "rgba(56, 189, 248, 0.18)",
    secondaryLine: "rgba(56, 189, 248, 0.08)",
    majorLine: "rgba(56, 189, 248, 0.45)",
    dots: "rgba(56, 189, 248, 0.32)",
    marginLine: "rgba(253, 224, 71, 0.45)",
    accent: "#38BDF8",
    subtleText: "rgba(56, 189, 248, 0.50)",
  },
};
